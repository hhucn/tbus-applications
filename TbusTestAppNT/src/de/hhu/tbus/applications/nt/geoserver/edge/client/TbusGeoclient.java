...
public class TbusGeoclient extends VehicleApplication {
	...
	protected void initConfig() {		
		try {
			config = (new TbusConfiguration<TbusGeoClientConfiguration>()).readConfiguration(TbusGeoClientConfiguration.class, TbusGeoClientConfiguration.configFilename, getOperatingSystem(), getLog());
	...
	public void setUp() {
		...
		getLog().info("TbusGeoClient constructor called at " + getOperatingSystem().getSimulationTime() + " for id " + getOperatingSystem().getId());
	}
