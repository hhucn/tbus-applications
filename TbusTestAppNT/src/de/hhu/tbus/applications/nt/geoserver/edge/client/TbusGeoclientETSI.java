...
import de.hhu.tbus.applications.nt.geoserver.edge.client.configuration.TbusGeoClientETSIConfiguration;
 ...
 * 
 */
public class TbusGeoclientETSI extends VehicleApplication {
	...
	private TbusGeoClientETSIConfiguration config;

	protected void initConfig() {
		try {
			config = (new TbusConfiguration<TbusGeoClientETSIConfiguration>())
					.readConfiguration(TbusGeoClientETSIConfiguration.class,
							TbusGeoClientETSIConfiguration.configFilename,
			...
			config = new TbusGeoClientETSIConfiguration();
		}
	}
