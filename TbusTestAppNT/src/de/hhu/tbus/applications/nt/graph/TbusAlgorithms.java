...
public class TbusAlgorithms<V, E extends SumoEdge> {
	...
	/**
	 * Get a list of all possible routes (lists of edges) starting with edge
	 * start and having a maximum length of maxDistance, excluding first and
	 * last edge, on the given graph
	 * 
	 * @param start
	 *            Starting edge
	 * @param maxDistance
	 *            Maximum distance of route, excluding first and last edge
	 * @return A list of all possible routes under the given values
	 */
	public synchronized List<List<String>> getRoutesWithinDisctance(E start,
			double maxDistance) {
		init();
	...
	/**
	 * Create routes starting from edge start with a maximum distance of
	 * maxDistance excluding the first edge.
	 * 
	 * @param start
	 *            Starting edge
	 * @param maxDistance
	 *            Maximum distance of route excluding the first and last edge
	 */
	 ...
	 * @return A list of all possible routes under the given values
	 */
	public synchronized List<List<String>> getRevertedRoutesWithinDisctance(
			E start, double maxDistance) {
		if (start == null) {
	...
	/**
	 * Create routes starting from edge start with a maximum distance of
	 * maxDistance excluding the first and last edge.
	 * 
	 * @param start
	 *            Starting edge
	 * @param maxDistance
